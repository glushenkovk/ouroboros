...
MODEL_MAIN = get_cfg("OUROBOROS_MODEL", default="google/gemini-2.5-flash-preview-05-20", allow_legacy_secret=True)
MODEL_CODE = get_cfg("OUROBOROS_MODEL_CODE", default="google/gemini-2.5-flash-preview-05-20", allow_legacy_secret=True)
...
os.environ["OUROBOROS_MODEL"] = str(MODEL_MAIN or "google/gemini-2.5-flash-preview-05-20")
os.environ["OUROBOROS_MODEL_CODE"] = str(MODEL_CODE or "google/gemini-2.5-flash-preview-05-20")
if MODEL_LIGHT:
